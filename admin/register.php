<?php include 'scripts/register.inc.php'; ?>
<!DOCTYPE html>
<html lang="en">
          ...
          <form action="register.php" method="POST">
            ...
            <div class="form-group">
              <div class="form-row">
                ...
                <div class="col-md-6">
                  <div class="form-label-group">
                    <input type="password" id="confirmPassword" name="c_password" class="form-control" placeholder="Confirm password" required="required">
